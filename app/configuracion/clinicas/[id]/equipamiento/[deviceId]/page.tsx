...
export default function DevicePage({ params }: { params: { id: string; deviceId: string } }) {
  ...
  const isNew = params.deviceId === "new"
    ...
    <div className="container mx-auto p-6 space-y-6 max-w-4xl pt-28 md:pt-16 pb-24">
      ...
      <div className="flex gap-2">
        <Button
          variant="outline"
          onClick={() =>
            router.push(`/configuracion/clinicas/${params.id}/equipamiento/${params.deviceId}/parametros/1`)
          }
        >
          Parámetro I
        </Button>
        <Button
          variant="outline"
          onClick={() =>
            router.push(`/configuracion/clinicas/${params.id}/equipamiento/${params.deviceId}/parametros/2`)
          }
        >
          Parámetro II
        </Button>
        <Button
          variant="outline"
          onClick={() =>
            router.push(`/configuracion/clinicas/${params.id}/equipamiento/${params.deviceId}/parametros/3`)
          }
        >
          Parámetro III
        </Button>
