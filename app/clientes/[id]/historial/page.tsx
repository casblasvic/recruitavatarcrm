        ...
        <div className="fixed bottom-16 md:bottom-0 left-0 right-0 bg-white border-t p-4 flex items-center justify-between z-50">
          ...
          <div className="flex items-center gap-2">
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              ...
              <DialogContent>
                <div className="p-6">
                  <h2 className="text-purple-900 mb-4 text-lg font-medium">Descripción</h2>
                  <Textarea
                    value={comment}
                    onChange={(e) => setComment(e.target.value)}
                    className="min-h-[120px] w-full resize-none rounded-lg border border-purple-200 p-3 focus:border-purple-500 focus:ring-purple-500"
